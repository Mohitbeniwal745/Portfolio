...
image: https://assets.mohit.com/images/blog/github-stars.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://mohit.com/r/github-stars.json"
/>
...
```tsx
<GithubStars repo="ncdai/mohit.com" stargazersCount={1050} />
```
