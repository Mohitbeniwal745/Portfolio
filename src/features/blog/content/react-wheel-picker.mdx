...
image: https://assets.mohit.com/images/blog/react-wheel-picker.webp?t=1747747932
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://mohit.com/r/wheel-picker.json"
  codeCollapsible
/>

## Features

Built on top of [React Wheel Picker](https://react-wheel-picker.mohit.com).
...
See the [React Wheel Picker](https://react-wheel-picker.mohit.com/docs/getting-started) documentation for more information.
